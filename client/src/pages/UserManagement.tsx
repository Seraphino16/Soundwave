...
const UserManagement: React.FC = () => {
  ...
  const fetchUsers = async () => {
    try {
      setLoading(true);
      const response: UserListResponse = await adminService.getAllUsers(currentPage, itemsPerPage, search || undefined, roleFilter, statusFilter);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <button type="submit" className="px-6 py-2 bg-primaryBlue text-white rounded-lg hover:bg-blue-600 transition">
                Filtrer
              </button>
            </form>
          </div>
        ...
        {showRoleModal && selectedUser && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Modifier le rôle de {selectedUser.pseudo}</h3>
              <div className="mb-4">
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button onClick={handleRoleUpdate} className="px-4 py-2 bg-primaryBlue text-white rounded-md hover:bg-blue-600">
                  Mettre à jour
                </button>
              </div>
            </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              ...
              <div className="flex justify-end space-x-3 mt-6">
                ...
                <button onClick={handleCreateUser} className="px-4 py-2 bg-primaryBlue text-white rounded-md hover:bg-blue-600">
                  Créer l'utilisateur
                </button>
              </div>
            </div>
        ...
        <ConfirmModal
          ...
          message={
            confirmAction === "delete"
              ...
              : `Êtes-vous sûr de vouloir ${userToBan?.is_active ? "bannir" : "débannir"} l'utilisateur ${userToBan?.username} ?`
          }
