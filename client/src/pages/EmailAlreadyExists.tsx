...
const EmailAlreadyExists: React.FC = () => (
  <>
    <Meta title="Soundwave - Email déjà utilisé" description="Page d'erreur pour un email déjà utilisé sur SoundWave" />
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md text-center">
        ...
        <Link to="/auth" className="text-primaryBlue hover:text-[#93D9D6] transition font-semibold">
