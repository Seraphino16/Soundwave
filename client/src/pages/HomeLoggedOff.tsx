      ...
      <div className="absolute top-0 left-0 w-full h-[70vh] bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('/background.jpg')" }}>
        ...
        <div className="relative z-10 max-w-4xl text-center bg-white p-12 rounded-xl shadow-lg border border-gray-300 bg-opacity-95">
          ...
          <div className="flex space-x-6 justify-center">
            <Link to="/signup" className="bg-primaryBlue text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-[#B0C7E6] transition text-center">
              S'inscrire
            </Link>
            <Link to="/login" className="bg-primaryBlue text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-[#B0C7E6] transition text-center">
              Se connecter
            </Link>
          </div>
        </div>
