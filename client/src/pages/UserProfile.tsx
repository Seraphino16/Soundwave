...
const UserProfilePage: React.FC = () => {
  ...
  const loadProfileData = async () => {
    try {
      ...
      const [wavesData, reviewsData] = await Promise.all([
        ...
        isOwnProfile ? userProfileService.getUserReviews() : Promise.resolve([]),
      ]);
  ...
  if (!displayProfile) {
    return (
      <>
        <Meta title="Soundwave - Profil introuvable" description="Profil utilisateur introuvable sur SoundWave" />
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                  <div className="mb-4 md:mb-0">
                    <div className="flex items-center space-x-3 mb-2">
                      <h1 className="text-2xl md:text-3xl font-bold text-gray-900">{displayProfile.pseudo}</h1>
                    ...
                    <div className="flex flex-wrap items-center space-x-4 text-sm text-gray-500 mb-3">
                      ...
                      {displayProfile.website && (
                        <div className="flex items-center space-x-1">
                          ...
                          <a href={displayProfile.website} target="_blank" rel="noopener noreferrer" className="text-primaryBlue hover:underline">
                ...
                <div className="flex border-b">
                  <button
                    ...
                    className={`flex-1 py-3 px-4 text-center font-medium border-b-2 transition ${
                      activeTab === "waves" ? "border-primaryBlue text-primaryBlue" : "border-transparent text-gray-500 hover:text-gray-700"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 px-4 text-center font-medium border-b-2 transition ${
                      activeTab === "reviews" ? "border-primaryBlue text-primaryBlue" : "border-transparent text-gray-500 hover:text-gray-700"
                    }`}
                  >
